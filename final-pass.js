(()=>{
  ...
  ready(()=>{
    ...
    function producer(s){
      ...
      const pipe=$('#pipeline');if(pipe){const revision=!!(s.v3ChangesRequested&&!s.v4Submitted||s.v4ChangesRequested),review=!!(!s.approval&&((s.v3Submitted&&!s.v3ChangesRequested)||s.v4Submitted)),postDone=!!(s.approval||s.v4Submitted||(s.v3Submitted&&!s.v3ChangesRequested));pipe.innerHTML=[pstage('Creative',!!s.creativeApproval,!s.creativeApproval,'方向确认',1),pstage('Production',!!s.genAsset,!!s.creativeApproval&&!s.genAsset,'Capture + AIGC',2),pstage('Post',postDone,!!s.genAsset&&!s.v3Submitted||revision,'Composite / Revision',3),pstage('Client Review',!!s.approval,review,'Version Decision',4),pstage('Delivery',!!s.deliveryRecord,!!s.approval&&!s.deliveryRecord,'Master / Deliverables',5),pstage('Archive',!!s.archiveRecord,!!s.deliveryRecord&&!s.archiveRecord,'Project Closure',6)].join('')}
    }
