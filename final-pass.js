(()=>{
  ...
  ready(()=>{
    ...
    function studio(s){
      ...
      if(client){const hasFormalVersion=!!(s.v3Submitted||s.v3ChangesRequested||s.v4Draft||s.v4Submitted||s.v4ChangesRequested||s.approval);client.href=hasFormalVersion?'review.html?stage=versions':'review.html?stage=creative';}
    }
