(()=>{
  ...
  ready(()=>{
    ...
    function renderInspector(){
      const drawer=$('.shotInspector');if(!drawer)return;const s=state(),reviewCurrent=!!(!s.approval&&((s.v3Submitted&&!s.v3ChangesRequested)||s.v4Submitted)),hasFormalVersion=!!(s.v3Submitted||s.v3ChangesRequested||s.v4Submitted||s.v4ChangesRequested||s.approval);
